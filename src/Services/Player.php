...
class Player {
	 ...
	 */
	public static function getPlayerDevices(): array {
		return [
			'requestType' => 'GET',
	 ...
	 * Authorization - Required
	 */
	public static function getRecentPlayedTracks(): array {
	 ...
	 * Authorization - Required
	 */
	public static function getPlayingTrack(): array {
		return [
			'requestType' => 'GET',
	 ...
	 * Authorization - Required
	 */
	public static function playerPause(): array {
		return [
			'requestType' => 'PUT',
	 ...
	 */
	public static function seekOnPosition( int $position_ms ): array {
		return [
	 ...
	 * @return array
	 */
	public static function setRepeatMode( string $state ): array {
		return [
	 ...
	 */
	public static function setPlayerVolume( int $volume_percent ): array {
	 ...
	 *
	 */
	public static function playerGoNext(): array {
		SpotifyPagination::setHasPagination( false );
	 ...
	 *
	 */
	public static function playerGoPrevious(): array {
		SpotifyPagination::setHasPagination( false );
	 ...
	 *
	 */
	public static function playerPlay(): array {
		SpotifyPagination::setHasPagination( false );
	 ...
	 */
	public static function playerShuffle( string $state ): array {
		SpotifyPagination::setHasPagination( false );
	 ...
	 */
	public static function transferPlayback( array $device_id ): array {
		SpotifyPagination::setHasPagination( false );
