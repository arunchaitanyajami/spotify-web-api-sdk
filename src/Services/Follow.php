...
class Follow {
	 ...
	 */
	public static function checkUserFollows( string $type, array $ids ): array {
	 ...
	 */
	public static function checkUserFollowPlaylist( string $playlist_id, array $ids ): array {
		SpotifyPagination::setHasPagination( false );
	 ...
	 */
	public static function followArtistsOrUsers( string $type, array $ids ): array {
		SpotifyPagination::setHasPagination( false );
	 ...
	 */
	public static function followPlaylist( string $playlist_id ): array {
		SpotifyPagination::setHasPagination( false );
	 ...
	 * Authorization - Required
	 */
	public static function whatIFollow(): array {
	 ...
	 */
	public static function unfollow( string $type, array $ids ): array {
		SpotifyPagination::setHasPagination( false );
	 ...
	 */
	public static function unfollowPlaylist( string $playlist_id ): array {
		SpotifyPagination::setHasPagination( false );
